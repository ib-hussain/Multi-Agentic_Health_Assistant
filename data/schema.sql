...
-- ALTER TABLE user_health_info ALTER COLUMN weight_kg SET DEFAULT 66.40;
-- ALTER TABLE user_health_info ALTER COLUMN height_m SET DEFAULT 1.70;
-- ALTER TABLE user_health_info ALTER COLUMN fitness_goal SET DEFAULT 'Get into better shape';
-- ALTER TABLE user_health_info ALTER COLUMN activity_level SET DEFAULT 'active';
